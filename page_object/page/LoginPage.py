...
class LoginPage(BasePage):
    ...
    def loginByPassword(self, account, password):
        ...
        self.loadSteps(LoginPage.yaml_path, "loginByPassword", var1=account, var2=password)
        return self
    ...
    def getErrorMsg(self):
        ...
        # self.loadSteps(LoginPage.yaml_path, 'getErrorMsg')
